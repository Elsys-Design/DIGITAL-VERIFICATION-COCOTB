...
\gen_AB_reg_slice.payload_a[8]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0D"
    )
        port map (
...
\gen_AB_reg_slice.payload_b[8]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D0"
    )
        port map (
...
entity design_1_xbar_0_axis_switch_v1_1_29_axis_switch is
  ...
  attribute P_TPAYLOAD_WIDTH of design_1_xbar_0_axis_switch_v1_1_29_axis_switch : entity is 9;
...
architecture STRUCTURE of design_1_xbar_0 is
  ...
  attribute X_INTERFACE_PARAMETER of s_axis_tdest : signal is "XIL_INTERFACENAME S00_AXIS, TDATA_NUM_BYTES 1, TDEST_WIDTH 1, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 10000000, PHASE 0.0, CLK_DOMAIN design_1_ACLK_0, LAYERED_METADATA undef, INSERT_VIP 0";
