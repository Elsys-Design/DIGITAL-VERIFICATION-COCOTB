...
The docmument décrit en détail le format du fichier de type Data.   
...
## Descripteur 
- Un descripteur sur la nature des données est identifié par le caractère spécial `@` et dont les champs ci-dessous sont séparés par un `;` et sur une unique ligne:
